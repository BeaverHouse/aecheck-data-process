...
const checkFiveStarExistsByCode = `-- name: CheckFiveStarExistsByCode :one
SELECT EXISTS(
...
func (q *Queries) CheckFiveStarExistsByCode(ctx context.Context, characterCode string) (bool, error) {
	row := q.db.QueryRow(ctx, checkFiveStarExistsByCode, characterCode)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}

const clearAllTiers = `-- name: ClearAllTiers :exec
UPDATE aecheck.characters
SET tier = NULL, updated_at = CURRENT_TIMESTAMP
WHERE tier IS NOT NULL
`

func (q *Queries) ClearAllTiers(ctx context.Context) error {
	_, err := q.db.Exec(ctx, clearAllTiers)
	return err
}
...
const getCharacterByCodeAndStyle = `-- name: GetCharacterByCodeAndStyle :one
SELECT character_id
...
type GetCharacterByCodeAndStyleParams struct {
	CharacterCode string `json:"character_code"`
	Style         string `json:"style"`
}

func (q *Queries) GetCharacterByCodeAndStyle(ctx context.Context, arg GetCharacterByCodeAndStyleParams) (string, error) {
	row := q.db.QueryRow(ctx, getCharacterByCodeAndStyle, arg.CharacterCode, arg.Style)
	var character_id string
	err := row.Scan(&character_id)
	return character_id, err
}

const getCharacterByEnglishName = `-- name: GetCharacterByEnglishName :one
...
type GetCharacterByEnglishNameParams struct {
	En      string `json:"en"`
	Style   string `json:"style"`
	IsAlter bool   `json:"is_alter"`
}

type GetCharacterByEnglishNameRow struct {
	CharacterID   string `json:"character_id"`
	CharacterCode string `json:"character_code"`
	Style         string `json:"style"`
	IsAlter       bool   `json:"is_alter"`
...
func (q *Queries) GetCharacterByEnglishName(ctx context.Context, arg GetCharacterByEnglishNameParams) (GetCharacterByEnglishNameRow, error) {
	row := q.db.QueryRow(ctx, getCharacterByEnglishName, arg.En, arg.Style, arg.IsAlter)
	var i GetCharacterByEnglishNameRow
	err := row.Scan(
		&i.CharacterID,
		&i.CharacterCode,
		&i.Style,
...
const getCharacterByJapaneseName = `-- name: GetCharacterByJapaneseName :one
SELECT c.character_id, c.character_code, c.style, c.is_alter
FROM aecheck.characters c
JOIN aecheck.translations t ON c.character_code = t.key
WHERE t.ja LIKE '%' || $1::text || '%' AND c.style = $2
LIMIT 1
`

type GetCharacterByJapaneseNameParams struct {
	Ja    string `json:"ja"`
	Style string `json:"style"`
}

type GetCharacterByJapaneseNameRow struct {
	CharacterID   string `json:"character_id"`
	CharacterCode string `json:"character_code"`
	Style         string `json:"style"`
	IsAlter       bool   `json:"is_alter"`
...
func (q *Queries) GetCharacterByJapaneseName(ctx context.Context, arg GetCharacterByJapaneseNameParams) (GetCharacterByJapaneseNameRow, error) {
	row := q.db.QueryRow(ctx, getCharacterByJapaneseName, arg.Ja, arg.Style)
	var i GetCharacterByJapaneseNameRow
	err := row.Scan(
		&i.CharacterID,
		&i.CharacterCode,
		&i.Style,
...
const getRandomCharacterWikiURL = `-- name: GetRandomCharacterWikiURL :one
SELECT aewiki_url
FROM aecheck.characters
...
func (q *Queries) GetRandomCharacterWikiURL(ctx context.Context) (pgtype.Text, error) {
	row := q.db.QueryRow(ctx, getRandomCharacterWikiURL)
...
const updateCharacterBuddyData = `-- name: UpdateCharacterBuddyData :exec
UPDATE aecheck.characters
SET buddy_data = $2, updated_at = CURRENT_TIMESTAMP
WHERE character_id = $1
`

type UpdateCharacterBuddyDataParams struct {
	CharacterID string `json:"character_id"`
	BuddyData   []byte `json:"buddy_data"`
}

func (q *Queries) UpdateCharacterBuddyData(ctx context.Context, arg UpdateCharacterBuddyDataParams) error {
	_, err := q.db.Exec(ctx, updateCharacterBuddyData, arg.CharacterID, arg.BuddyData)
	return err
}

const updateCharacterTier = `-- name: UpdateCharacterTier :exec
UPDATE aecheck.characters
SET tier = $2, updated_at = CURRENT_TIMESTAMP
WHERE character_id = $1
`

type UpdateCharacterTierParams struct {
	CharacterID string      `json:"character_id"`
	Tier        pgtype.Text `json:"tier"`
}

func (q *Queries) UpdateCharacterTier(ctx context.Context, arg UpdateCharacterTierParams) error {
	_, err := q.db.Exec(ctx, updateCharacterTier, arg.CharacterID, arg.Tier)
	return err
}
